...
jpeg("../../Output/GenomecovXmethod_sample_avg.jpg", width = 4.5, height = 3, units = "in", res = 300)
...
jpeg("../../Output/CpGcovXmethod_sample_avg.jpg", width = 4.5, height = 3, units = "in", res = 300)
