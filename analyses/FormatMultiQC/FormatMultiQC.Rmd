...
```{r}
jpeg("../../Output/Pact_Mcap_boxplot_methodXuniquely_mapped_reads.jpg", width = 6, height= 3, units = "in", res = 300 )
...
```{r}
jpeg("../../Output/Pact_Mcap_boxplot_methodXmethCpG.jpg", width = 6, height= 3, units = "in", res = 300 )
