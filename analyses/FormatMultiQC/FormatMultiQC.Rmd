...
multi_bismark_simp$Sequencing.Method <- gsub("MBD.*", "MBD", multi_bismark_simp$Sequencing.Method)
...
kable(multi_bismark_simp, row.names = FALSE,align='ccccccc') %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))  %>% row_spec(c(1:3,10:12), color = 'black', background = "#EDF8E9") %>% row_spec(c(4:6,13:15), color = 'black', background = "#F2F0F7") %>% row_spec(c(7:9,16:18), color = 'black', background = '#FEEDDE') %>% column_spec (1:8,border_left = T, border_right = T)  %>% column_spec(column = 1, width = "100px") %>% as_image(file = "../../Output/Summary_descriptive_statistics_Mcap_Pact.jpg")
