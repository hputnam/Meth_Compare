...
ggbarplot(multi_bismark_simp_stacked_l, x = "species", y = "reads", add = "mean_sd", palette = "jco", color = "category", facet.by = "method", scales = "free_y") + theme(axis.title.x=element_blank(),axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1,face = "italic"), strip.background =element_rect(fill="white"))
dev.off()
```
