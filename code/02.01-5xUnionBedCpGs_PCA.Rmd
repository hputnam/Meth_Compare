...
a <- ggplot(Mcap_5x_pca_meta, aes(PC1, PC2)) + geom_point(aes(color = Method), size = 3) + scale_color_manual(values = c("#FD8D3C","#9E9AC8","#74C476")) + theme_bw() + ylab(paste0("PC2 (", round(summary(Mcap_5x_pca)[[6]][[5]]*100,2),"% variation explained)")) + xlim(-700,900) + ylim(-550,450) +xlab(paste0("PC1 (",round(summary(Mcap_5x_pca)[[6]][[2]]*100,2),"% variation explained)")) + labs(color = "method") + ggtitle("read threshold: 5x") +  theme(plot.title = element_text(hjust = 0.5))

b <- ggplot(Mcap_10x_pca_meta, aes(PC1, PC2)) + geom_point(aes(color = Method), size = 3) + scale_color_manual(values = c("#FD8D3C","#9E9AC8","#74C476")) + theme_bw() + ylab(paste0("PC2 (", round(summary(Mcap_10x_pca)[[6]][[5]]*100,2),"% variation explained)")) + xlim(-700,900) + ylim(-550,450)+ xlab(paste0("PC1 (",round(summary(Mcap_10x_pca)[[6]][[2]]*100,2),"% variation explained)")) + labs(color = "method") + ggtitle("read threshold: 10x") +  theme(plot.title = element_text(hjust = 0.5))

c <- ggplot(Mcap_50x_pca_meta, aes(PC1, PC2)) + geom_point(aes(color = Method), size = 3) + scale_color_manual(values = c("#FD8D3C","#9E9AC8","#74C476")) + theme_bw() + ylab(paste0("PC2 (", round(summary(Mcap_50x_pca)[[6]][[5]]*100,2),"% variation explained)")) + xlim(-700,900) + ylim(-550,450)+ xlab(paste0("PC1 (",round(summary(Mcap_50x_pca)[[6]][[2]]*100,2),"% variation explained)")) + labs(color = "method") + ggtitle("read threshold: 50x") +  theme(plot.title = element_text(hjust = 0.5))

d <- ggplot(Mcap_100x_pca_meta, aes(PC1, PC2)) + geom_point(aes(color = Method), size = 3) + scale_color_manual(values = c("#FD8D3C","#9E9AC8","#74C476")) + theme_bw() + ylab(paste0("PC2 (", round(summary(Mcap_100x_pca)[[6]][[5]]*100,2),"% variation explained)")) + xlim(-700,900) + ylim(-550,450)+ xlab(paste0("PC1 (",round(summary(Mcap_100x_pca)[[6]][[2]]*100,2),"% variation explained)")) + labs(color = "method") + ggtitle("read threshold: 100x") +  theme(plot.title = element_text(hjust = 0.5))

e <- ggplot(Pact_5x_pca_meta, aes(PC1, PC2)) + geom_point(aes(color = Method), size = 3) + scale_color_manual(values = c("#FD8D3C","#9E9AC8","#74C476")) + theme_bw() + ylab(paste0("PC2 (", round(summary(Pact_5x_pca)[[6]][[5]]*100,2),"% variation explained)")) + xlim(-4000,8000) + ylim(-3500,2500) +xlab(paste0("PC1 (",round(summary(Pact_5x_pca)[[6]][[2]]*100,2),"% variation explained)")) + labs(color = "method") 

f <- ggplot(Pact_10x_pca_meta, aes(PC1, PC2)) + geom_point(aes(color = Method), size = 3) + scale_color_manual(values = c("#FD8D3C","#9E9AC8","#74C476")) + theme_bw() + ylab(paste0("PC2 (", round(summary(Pact_10x_pca)[[6]][[5]]*100,2),"% variation explained)")) + xlim(-4000,8000) + ylim(-3500,2500)+ xlab(paste0("PC1 (",round(summary(Pact_10x_pca)[[6]][[2]]*100,2),"% variation explained)")) + labs(color = "method") 

g <- ggplot(Pact_50x_pca_meta, aes(PC1, PC2)) + geom_point(aes(color = Method), size = 3) + scale_color_manual(values = c("#FD8D3C","#9E9AC8","#74C476")) + theme_bw() + ylab(paste0("PC2 (", round(summary(Pact_50x_pca)[[6]][[5]]*100,2),"% variation explained)")) + xlim(-4000,8000) + ylim(-3500,2500) + xlab(paste0("PC1 (",round(summary(Pact_50x_pca)[[6]][[2]]*100,2),"% variation explained)")) + labs(color = "method") 

h <- ggplot(Pact_100x_pca_meta, aes(PC1, PC2)) + geom_point(aes(color = Method), size = 3) + scale_color_manual(values = c("#FD8D3C","#9E9AC8","#74C476")) + theme_bw() + ylab(paste0("PC2 (", round(summary(Pact_100x_pca)[[6]][[5]]*100,2),"% variation explained)")) + xlim(-4000,8000) + ylim(-3500,2500)+ xlab(paste0("PC1 (",round(summary(Pact_100x_pca)[[6]][[2]]*100,2),"% variation explained)")) + labs(color = "method") 
...
figure <- ggarrange(a, b,c,d,e,f,g,h, labels = "AUTO" , ncol = 4,nrow = 2,common.legend = TRUE, legend = "top")

jpeg("OLD_Output/5x-100xCpG_Methylation.jpg", width = 15, height = 8, units = "in", res = 300)
figure
dev.off()
