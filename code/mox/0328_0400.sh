#!/bin/bash
## Job Name
#SBATCH --job-name=lam-2
##  This script is meant to align trim galore data to lambda
##  specifically MG1655
...
#SBATCH --chdir=/gscratch/scrubbed/sr320/032820-lambda
...
mkdir lambda_tg
mkdir lambda_tg/dedup
cp lambda_tg/Meth10*bam lambda_tg/dedup/
cp lambda_tg/Meth11*bam lambda_tg/dedup/
cp lambda_tg/Meth12*bam lambda_tg/dedup/
cp lambda_tg/Meth16*bam lambda_tg/dedup/
cp lambda_tg/Meth17*bam lambda_tg/dedup/
cp lambda_tg/Meth18*bam lambda_tg/dedup/

mkdir lambda_tg/nodedup
cp lambda_tg/Meth13*bam lambda_tg/nodedup/
cp lambda_tg/Meth14*bam lambda_tg/nodedup/
cp lambda_tg/Meth15*bam lambda_tg/nodedup/
