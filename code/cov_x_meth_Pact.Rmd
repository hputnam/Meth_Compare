...
Pact_cov_perc_group_3x_mbd_rel_sum_wgbs_cutoffs <- Pact_cov_perc_group_3x_mbd_rel_sum_wgbs_cutoffs %>% group_by(id) %>% mutate(perc_CpG = CpGs/sum(CpGs)*100)
```
