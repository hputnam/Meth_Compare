...
This includes a multipanel plot (main text) and statistical output (supplemental material)

### Combined statistical output table
...
head(CpGLocationStatOutput) #Confirm table creation
```
