...
```{r}
McapAll <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Mcap/Mcap-5x-bedgraph-counts.txt", header = FALSE, col.names = c("totalLines", "filename")) #Import file using space as a delimiter. Columns are the number of lines and the filename
McapAll <- McapAll[-10,] #Remove last row (total lines for all files)
tail(McapAll) #Confirm import
```

```{r}
McapMeth <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Mcap/Mcap-5x-Meth-counts.txt", header = FALSE, col.names = c("Meth", "filename")) #Import file using space as a delimiter. Columns are the number of lines and the filename
McapMeth <- McapMeth[-10,] #Remove last row (total lines for all files)
tail(McapMeth) #Confirm import
```

```{r}
McapSparseMeth <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Mcap/Mcap-5x-sparseMeth-counts.txt", header = FALSE, col.names = c("sparseMeth", "filename")) #Import file using space as a delimiter. Columns are the number of lines and the filename
McapSparseMeth <- McapSparseMeth[-10,] #Remove last row (total lines for all files)
tail(McapSparseMeth) #Confirm import
```

```{r}
McapUnMeth <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Mcap/Mcap-5x-unMeth-counts.txt", header = FALSE, col.names = c("unMeth", "filename")) #Import file using space as a delimiter. Columns are the number of lines and the filename
...
```{r}
write.table(McapCpGType, "../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Mcap/Mcap-CpG-Type.txt", sep = "\t", quote = FALSE, row.names = TRUE) #Save summary table
```
...
```{r}
PactAll <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Pact/Pact-5x-bedgraph-counts.txt", header = FALSE, col.names = c("totalLines", "filename")) #Import file using space as a delimiter. Columns are the number of lines and the filename
PactAll <- PactAll[-10,] #Remove last row (total lines for all files)
tail(PactAll) #Confirm import
```

```{r}
PactMeth <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Pact/Pact-5x-Meth-counts.txt", header = FALSE, col.names = c("Meth", "filename")) #Import file using space as a delimiter. Columns are the number of lines and the filename
PactMeth <- PactMeth[-10,] #Remove last row (total lines for all files)
tail(PactMeth) #Confirm import
```

```{r}
PactSparseMeth <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Pact/Pact-5x-sparseMeth-counts.txt", header = FALSE, col.names = c("sparseMeth", "filename")) #Import file using space as a delimiter. Columns are the number of lines and the filename
PactSparseMeth <- PactSparseMeth[-10,] #Remove last row (total lines for all files)
tail(PactSparseMeth) #Confirm import
```

```{r}
PactUnMeth <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Pact/Pact-5x-unMeth-counts.txt", header = FALSE, col.names = c("unMeth", "filename")) #Import file using space as a delimiter. Columns are the number of lines and the filename
...
```{r}
write.table(PactCpGType, "../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Pact/Pact-CpG-Type.txt", sep = "\t", quote = FALSE, row.names = TRUE) #Save summary table
```
...
```{r}
McapGenomeFeatures <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Mcap/Mcap-CGMotif-Overlaps-counts.txt", header = FALSE, col.names = c("counts", "filename")) #Import file with CG motif and feature track overlaps
McapGenomeFeatures <- McapGenomeFeatures[-c(8:9),] #Remove final row
tail(McapGenomeFeatures) #Check import
```

```{r}
McapGeneOverlaps <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Mcap/Mcap-5x-mcGenes-counts.txt", header = FALSE, col.names = c("counts", "filename")) #Import file with all file-gene overlaps
McapGeneOverlaps <- McapGeneOverlaps[-37,] #Remove final row
tail(McapGeneOverlaps) #Confirm import
```

```{r}
McapCDSOverlaps <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Mcap/Mcap-5x-mcCDS-counts.txt", header = FALSE, col.names = c("counts", "filename")) #Import file with all file-CDS overlaps
McapCDSOverlaps <- McapCDSOverlaps[-37,] #Remove final row
tail(McapCDSOverlaps) #Confirm import
```

```{r}
McapIntronsOverlaps <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Mcap/Mcap-5x-mcIntrons-counts.txt", header = FALSE, col.names = c("counts", "filename")) #Import file with all file-Introns overlaps
McapIntronsOverlaps <- McapIntronsOverlaps[-37,] #Remove final row
tail(McapIntronsOverlaps) #Confirm import
```

```{r}
McapFlanksOverlaps <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Mcap/Mcap-5x-mcFlanks-counts.txt", header = FALSE, col.names = c("counts", "filename")) #Import file with all file-flank overlaps
McapFlanksOverlaps <- McapFlanksOverlaps[-37,] #Remove final row
tail(McapFlanksOverlaps) #Confirm import
```

```{r}
McapFlanksUpstreamOverlaps <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Mcap/Mcap-5x-mcFlanksUpstream-counts.txt", header = FALSE, col.names = c("counts", "filename")) #Import file with all file-upstream flank overlaps
McapFlanksUpstreamOverlaps <- McapFlanksUpstreamOverlaps[-37,] #Remove final row
tail(McapFlanksUpstreamOverlaps) #Confirm import
```

```{r}
McapFlanksDownstreamOverlaps <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Mcap/Mcap-5x-mcFlanksDownstream-counts.txt", header = FALSE, col.names = c("counts", "filename")) #Import file with all file-Introns overlaps
McapFlanksUpstreamOverlaps <- McapFlanksUpstreamOverlaps[-37,] #Remove final row
tail(McapFlanksDownstreamOverlaps) #Confirm import
```

```{r}
McapIntergenicOverlaps <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Mcap/Mcap-5x-mcIntergenic-counts.txt", header = FALSE, col.names = c("counts", "filename")) #Import file with all file-Intergenic overlaps
...
```{r}
write.table(McapFeatureOverlaps, "../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Mcap/Mcap_union-Genomic-Location-Counts.txt", sep = "\t", quote = FALSE, row.names = TRUE) #Save file
```
...
```{r}
write.table(McapFeatureOverlapsPercents, "../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Mcap/Mcap_union-Genomic-Location-Percents.txt", sep = "\t", quote = FALSE, row.names = TRUE) #Save file
```
...
```{r}
McapFeatureOverlapsStatResults <- data.frame("species" = rep("Mcap", times = 4),
                                             "contrast" = c("global", "WGBS vs. RRBS", "WGBS vs. MBDBS", "RRBS vs. MBDBS"),
                                             "PERMANOVA-R2" = rep(0, times = 4),
                                             "Adonis-P-value" = rep(0, times = 4),
                                             "Beta-disp-F-stat" = rep(0, times = 4),
                                             "ANOVA-P-value" = rep(0, times = 4)) #Create an empty dataframe for stat test results
head(McapFeatureOverlapsStatResults) #Confirm dataframe creation
```

```{r}
#PERMANOVA stats
McapFeatureOverlapsStatResults$PERMANOVA.R2[1] <- McapFeatureOverlapsTest$aov.tab$R2[1] #Global PERMANOVA stat
McapFeatureOverlapsStatResults$PERMANOVA.R2[2] <- McapFeatureOverlapsWGRRTest$aov.tab$R2[1] #WGBS vs. RRBS PERMANOVA stat
McapFeatureOverlapsStatResults$PERMANOVA.R2[3] <- McapFeatureOverlapsWGMBTest$aov.tab$R2[1] #WGBS vs. MBDBS PERMANOVA stat
McapFeatureOverlapsStatResults$PERMANOVA.R2[4] <- McapFeatureOverlapsRRMBTest$aov.tab$R2[1] #RRBS vs. MBDBS PERMANOVA stat

#Adonis P-values
McapFeatureOverlapsStatResults$Adonis.P.value[1] <- McapFeatureOverlapsTest$aov.tab$`Pr(>F)`[1] #Global PERMANOVA P-value
McapFeatureOverlapsStatResults$Adonis.P.value[2] <- McapFeatureOverlapsWGRRTest$aov.tab$`Pr(>F)`[1] #Global PERMANOVA P-value
McapFeatureOverlapsStatResults$Adonis.P.value[3] <- McapFeatureOverlapsWGMBTest$aov.tab$`Pr(>F)`[1] #Global PERMANOVA P-value
McapFeatureOverlapsStatResults$Adonis.P.value[4] <- McapFeatureOverlapsRRMBTest$aov.tab$`Pr(>F)`[1] #Global PERMANOVA P-value

head(McapFeatureOverlapsStatResults) #Confirm formatting
```
...
```{r}
PactGeneOverlaps <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Pact/Pact-5x-paGenes-counts.txt", header = FALSE, col.names = c("counts", "filename")) #Import file with all file-gene overlaps
PactGeneOverlaps <- PactGeneOverlaps[-37,] #Remove final row
tail(PactGeneOverlaps) #Confirm import
```

```{r}
PactCDSOverlaps <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Pact/Pact-5x-paCDS-counts.txt", header = FALSE, col.names = c("counts", "filename")) #Import file with all file-CDS overlaps
PactCDSOverlaps <- PactCDSOverlaps[-37,] #Remove final row
tail(PactCDSOverlaps) #Confirm import
```

```{r}
PactIntronsOverlaps <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Pact/Pact-5x-paIntron-counts.txt", header = FALSE, col.names = c("counts", "filename")) #Import file with all file-Introns overlaps
PactIntronsOverlaps <- PactIntronsOverlaps[-37,] #Remove final row
tail(PactIntronsOverlaps) #Confirm import
```

```{r}
PactFlanksOverlaps <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Pact/Pact-5x-paFlanks-counts.txt", header = FALSE, col.names = c("counts", "filename")) #Import file with all file-flanks overlaps
PactFlanksOverlaps <- PactFlanksOverlaps[-37,] #Remove final row
tail(PactFlanksOverlaps) #Confirm import
```

```{r}
PactFlanksUpstreamOverlaps <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Pact/Pact-5x-paFlanksUpstream-counts.txt", header = FALSE, col.names = c("counts", "filename")) #Import file with all file-upstream flanks overlaps
PactFlanksUpstreamOverlaps <- PactFlanksUpstreamOverlaps[-37,] #Remove final row
tail(PactFlanksUpstreamOverlaps) #Confirm import
```

```{r}
PactFlanksDownstreamOverlaps <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Pact/Pact-5x-paFlanksDownstream-counts.txt", header = FALSE, col.names = c("counts", "filename")) #Import file with all file-downstream flanks overlaps
...
```{r}
PactIntergenicOverlaps <- read.table("../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Pact/Pact-5x-paIntergenic-counts.txt", header = FALSE, col.names = c("counts", "filename")) #Import file with all file-Intergenic overlaps
...
```{r}
write.table(PactFeatureOverlaps, "../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Pact/Pact_union-Genomic-Location-Counts.txt", sep = "\t", quote = FALSE, row.names = TRUE) #Save file
```
...
```{r}
write.table(PactFeatureOverlapsPercents, "../output/intermediate-files/02-Characterizing-CpG-Methylation-5x/Pact/Pact_union-Genomic-Location-Percents.txt", sep = "\t", quote = FALSE, row.names = TRUE) #Save file
```
...
```{r}
PactFeatureOverlapsStatResults <- data.frame("species" = rep("Pact", times = 4),
                                             "contrast" = c("global", "WGBS vs. RRBS", "WGBS vs. MBDBS", "RRBS vs. MBDBS"),
                                             "PERMANOVA-R2" = rep(0, times = 4),
                                             "Adonis-P-value" = rep(0, times = 4),
                                             "Beta-disp-F-stat" = rep(0, times = 4),
                                             "ANOVA-P-value" = rep(0, times = 4)) #Create an empty dataframe for stat test results
head(PactFeatureOverlapsStatResults) #Confirm dataframe creation
```

```{r}
anova(disp.PactFeatureOverlapsTrans)[[5]][1]
...
```{r}
#PERMANOVA stats
PactFeatureOverlapsStatResults$PERMANOVA.R2[1] <- PactFeatureOverlapsTest$aov.tab$R2[1] #Global PERMANOVA stat
PactFeatureOverlapsStatResults$PERMANOVA.R2[2] <- PactFeatureOverlapsWGRRTest$aov.tab$R2[1] #WGBS vs. RRBS PERMANOVA stat
PactFeatureOverlapsStatResults$PERMANOVA.R2[3] <- PactFeatureOverlapsWGMBTest$aov.tab$R2[1] #WGBS vs. MBDBS PERMANOVA stat
PactFeatureOverlapsStatResults$PERMANOVA.R2[4] <- PactFeatureOverlapsRRMBTest$aov.tab$R2[1] #RRBS vs. MBDBS PERMANOVA stat

#Adonis P-values
PactFeatureOverlapsStatResults$Adonis.P.value[1] <- PactFeatureOverlapsTest$aov.tab$`Pr(>F)`[1] #Global PERMANOVA P-value
PactFeatureOverlapsStatResults$Adonis.P.value[2] <- PactFeatureOverlapsWGRRTest$aov.tab$`Pr(>F)`[1] #WGBS vs. RRBS PERMANOVA P-value
PactFeatureOverlapsStatResults$Adonis.P.value[3] <- PactFeatureOverlapsWGMBTest$aov.tab$`Pr(>F)`[1] #WGBS vs. MBDBS PERMANOVA P-value
PactFeatureOverlapsStatResults$Adonis.P.value[4] <- PactFeatureOverlapsRRMBTest$aov.tab$`Pr(>F)`[1] #RRBS vs. MBDBS PERMANOVA P-value

#Beta dispersion test F-statistic
PactFeatureOverlapsStatResults$Beta.disp.F.stat[1] <- anova(disp.PactFeatureOverlapsTrans)[[4]][1] #Global beta dispersion test
PactFeatureOverlapsStatResults$Beta.disp.F.stat[2] <- anova(disp.PactFeatureOverlapsWGRR)[[4]][1] #WGBS vs. RRBS beta dispersion test
PactFeatureOverlapsStatResults$Beta.disp.F.stat[3] <- anova(disp.PactFeatureOverlapsWGMB)[[4]][1] #WGBS vs. MBDBS beta dispersion test
PactFeatureOverlapsStatResults$Beta.disp.F.stat[4] <- anova(disp.PactFeatureOverlapsRRMB)[[4]][1] #RRBS vs. MBDBS beta dispersion test

#ANOVA P-value
PactFeatureOverlapsStatResults$ANOVA.P.value[1] <- anova(disp.PactFeatureOverlapsTrans)[[5]][1] #Global beta dispersion test
PactFeatureOverlapsStatResults$ANOVA.P.value[2] <- anova(disp.PactFeatureOverlapsWGRR)[[5]][1] #WGBS vs. RRBS beta dispersion test
PactFeatureOverlapsStatResults$ANOVA.P.value[3] <- anova(disp.PactFeatureOverlapsWGMB)[[5]][1] #WGBS vs. MBDBS beta dispersion test
PactFeatureOverlapsStatResults$ANOVA.P.value[4] <- anova(disp.PactFeatureOverlapsRRMB)[[5]][1] #RRBS vs. MBDBS beta dispersion test

head(PactFeatureOverlapsStatResults) #Confirm formatting
```

# Supplementary material

This will include a multipanel PCoA plot and a table with statistical output

## Statistical output table

```{r}
FeatureOverlapStatResults <- rbind(McapFeatureOverlapsStatResults,
                                   PactFeatureOverlapsStatResults) #Combine tables
FeatureOverlapStatResults$Beta.disp.F.stat[1:4] <- "NA" #Replace 0 with NA
FeatureOverlapStatResults$ANOVA.P.value[1:4] <- "NA" #Replace 0 with NA
head(FeatureOverlapStatResults) #Confirm table creation
```

```{r}
write.csv(FeatureOverlapStatResults, "../output/supplemental-material/ST6.csv",  quote = FALSE, row.names = FALSE) #Save file
```

## Multipanel PCoA plot
...
plotColors <- c(rev(RColorBrewer::brewer.pal(3, "Greens")), 
                ...
                rev(RColorBrewer::brewer.pal(3, "Oranges"))) #Create vector of WGBS, RRBS, and MBDBS colors
```

```{r}
plotCustomization <- data.frame("Mcap" = 10:18,
                                "Pact" = 1:9,
                                sampleInformation) #Create dataframe with sample treatment information
tail(plotCustomization) #Confirm dataframe creation
```

### Create plot

```{r}
pdf("../output/supplemental-material/SF5.pdf", height = 8.5, width = 11) #Save plot
