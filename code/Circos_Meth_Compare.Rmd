...
Mcap.gene.cytoband.tail <- c(2,max(Mcap_union$end)+1,max(Mcap_union$end)+2,0,1)
...
#cell padding bottom, left, top and right
circos.par(gap.after=5, canvas.xlim=c(-1.143,1.143))
