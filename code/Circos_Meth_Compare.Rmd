...
circos.yaxis(side="right", labels = TRUE, tick=TRUE, at=c(0,0.5,1))
...
set.seed(123)
circos.par("track.height" = 0.2, start.degree = 0, gap.degree = 20, cell.padding = c(0.01,1,0.01,1))
