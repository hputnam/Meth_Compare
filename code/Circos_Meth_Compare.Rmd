...
pdf('../Output/Circos_plots/Coral_genes_CpG_3methods_topscaff.pdf', width=6, height=12)
par(mfrow=c(2,1))
circos.clear()

set.seed(123)
circos.par("track.height" = 0.2, start.degree = 0, gap.degree = 45, cell.padding = c(0.01,1,0.01,1))
