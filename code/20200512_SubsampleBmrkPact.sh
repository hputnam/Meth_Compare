...
#SBATCH --chdir=/gscratch/scrubbed/strigg/analyses/20200507
...
reads_dir="/gscratch/scrubbed/strigg/analyses/20200505/"
...
mkdir Pact_tg/dedup
cp Pact_tg/Pact_MBD*.bam Pact_tg/dedup/
cp Pact_tg/Pact_WGBS*.bam Pact_tg/dedup/

mkdir Pact_tg/nodedup
cp Pact_tg/Pact_RRBS*.bam Pact_tg/nodedup/
