...
#wgbs zoomed
c <- ggplot(Pact_l_m_1x_tag_STACKED[which(Pact_l_m_1x_tag_STACKED$tag!="[0-10]" & Pact_l_m_1x_tag_STACKED$tag!="[10-20]" & Pact_l_m_1x_tag_STACKED$method=="WGBS" & Pact_l_m_1x_tag_STACKED$group_simp!="MBD, RRBS" & Pact_l_m_1x_tag_STACKED$group_simp!="MBD, WGBS"),],aes(x = method, y = perc_CpG*100, fill = as.factor(method), alpha = tag, group = method )) + geom_bar(stat = "identity",position = "stack", color = "black") + theme_bw() + theme(axis.text.x = element_text(size = 7, angle = 60, hjust = 1), axis.title = element_text(size = 12, face = "bold")) + scale_fill_manual(values =c("#31A354"))  + scale_y_continuous(expand = expansion(mult = c(0, 0.1))) + scale_alpha_manual(values=c(seq(0.3,1, length.out = 8)))+ labs(x = "method", y = "% CpGs",fill = "method", alpha = "% methylation") + guides(fill=guide_legend(reverse=T)) + theme(axis.title.x=element_blank(),axis.text.x=element_blank(),axis.ticks.x=element_blank()) + facet_wrap(~group_simp, scale="free") + theme(strip.background = element_rect(fill=NA,colour="grey50"))

#RRBS zoomed
b <- ggplot(Pact_l_m_1x_tag_STACKED[which(Pact_l_m_1x_tag_STACKED$tag!="[0-10]" & Pact_l_m_1x_tag_STACKED$tag!="[10-20]" & Pact_l_m_1x_tag_STACKED$method=="RRBS" & Pact_l_m_1x_tag_STACKED$group_simp!="MBD, RRBS" & Pact_l_m_1x_tag_STACKED$group_simp!="MBD, WGBS"),],aes(x = method, y = perc_CpG*100, fill = as.factor(method), alpha = tag, group = method )) + geom_bar(stat = "identity",position = "stack", color = "black") + theme_bw() + theme(axis.text.x = element_text(size = 7, angle = 60, hjust = 1), axis.title = element_text(size = 12, face = "bold")) + scale_fill_manual(values =c("#756BB1"))  + scale_y_continuous(expand = expansion(mult = c(0, 0.1))) + scale_alpha_manual(values=c(seq(0.3,1, length.out = 8)))+ labs(x = "method", y = "% CpGs",fill = "method", alpha = "% methylation") + guides(fill=guide_legend(reverse=T)) + theme(axis.title.x=element_blank(),axis.text.x=element_blank(),axis.ticks.x=element_blank()) + facet_wrap(~group_simp, scale="free") + theme(strip.background = element_rect(fill=NA,colour="grey50"))
...
#wgbs zoomed
f <- ggplot(Pact_l_m_3x_tag_STACKED[which(Pact_l_m_1x_tag_STACKED$tag!="[0-10]" & Pact_l_m_1x_tag_STACKED$tag!="[10-20]" & Pact_l_m_1x_tag_STACKED$method=="WGBS" & Pact_l_m_1x_tag_STACKED$group_simp!="MBD, RRBS" & Pact_l_m_1x_tag_STACKED$group_simp!="MBD, WGBS"),],aes(x = method, y = perc_CpG*100, fill = as.factor(method), alpha = tag, group = method )) + geom_bar(stat = "identity",position = "stack", color = "black") + theme_bw() + theme(axis.text.x = element_text(size = 7, angle = 60, hjust = 1), axis.title = element_text(size = 12, face = "bold")) + scale_fill_manual(values =c("#31A354"))  + scale_y_continuous(expand = expansion(mult = c(0, 0.1))) + scale_alpha_manual(values=c(seq(0.3,1, length.out = 8)))+ labs(x = "method", y = "% CpGs",fill = "method", alpha = "% methylation") + guides(fill=guide_legend(reverse=T)) + theme(axis.title.x=element_blank(),axis.text.x=element_blank(),axis.ticks.x=element_blank()) + facet_wrap(~group_simp, scale="free") + theme(strip.background = element_rect(fill=NA,colour="grey50"))

#RRBS zoomed
e <- ggplot(Pact_l_m_1x_tag_STACKED[which(Pact_l_m_1x_tag_STACKED$tag!="[0-10]" & Pact_l_m_1x_tag_STACKED$tag!="[10-20]" & Pact_l_m_1x_tag_STACKED$method=="RRBS" & Pact_l_m_1x_tag_STACKED$group_simp!="MBD, RRBS" & Pact_l_m_1x_tag_STACKED$group_simp!="MBD, WGBS"),],aes(x = method, y = perc_CpG*100, fill = as.factor(method), alpha = tag, group = method )) + geom_bar(stat = "identity",position = "stack", color = "black") + theme_bw() + theme(axis.text.x = element_text(size = 7, angle = 60, hjust = 1), axis.title = element_text(size = 12, face = "bold")) + scale_fill_manual(values =c("#756BB1"))  + scale_y_continuous(expand = expansion(mult = c(0, 0.1))) + scale_alpha_manual(values=c(seq(0.3,1, length.out = 8)))+ labs(x = "method", y = "% CpGs",fill = "method", alpha = "% methylation") + guides(fill=guide_legend(reverse=T)) + theme(axis.title.x=element_blank(),axis.text.x=element_blank(),axis.ticks.x=element_blank()) + facet_wrap(~group_simp, scale="free") + theme(strip.background = element_rect(fill=NA,colour="grey50"))
