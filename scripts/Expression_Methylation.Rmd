...
pdf("Output/gene_expression_present.pdf", width=8.5, height=6)
McapEP <- plot_multi_histogram(Mcap.CpG.counts.present, 'plusone', 'method')
dev.off()

pdf("Output/gene_expression_absent.pdf", width=8.5, height=6)
...
ggsave("Output/gene_expression_distributions.pdf", width=8.5, height=6)
...
plot_multi_histogram(Pact.CpG.counts.present, 'plusone', 'method')
...
#For Genes Absent in the 3 groups
plot_multi_histogram(Pact.CpG.counts.absent, 'plusone', 'method')
