...
legend(x = 0.62, y = 0.87, 
       ...
       cex = 1.5, 
       x.intersp = 0.7, xjust = 0) #Place a legend in the top right of the figure with no box
text("Genome Feature", x = 0.85, y = 0.879, cex = 1.5) #Add legend title that is aligned with legend
...
AllFeature$comparison <- rep("Mcap vs. Pact", times = 5) #Add methods compared
...
WGBSFeature$comparison <- rep("Mcap vs. Pact", times = 5) #Add methods compared
...
RRBSFeature$comparison <- rep("Mcap vs. Pact", times = 5) #Add methods compared
...
MBDBSFeature$comparison <- rep("Mcap vs. Pact", times = 5) #Add methods compared
