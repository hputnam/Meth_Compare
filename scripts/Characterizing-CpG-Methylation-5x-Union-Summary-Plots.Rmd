...
MBDBSCpGType$comparison <- rep("Mcap vs. Pact", times = 3) #Add methods compared
...
row.names(McapFeatureOverlaps) <- c("Genes", "CDS", "Introns", "Upstream Flanks", "Downstream Flanks", "Intergenic") #Assign row names
