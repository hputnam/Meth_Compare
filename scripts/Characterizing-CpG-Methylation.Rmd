...
```{r}
emmeans(McapCpGHighModel, pairwise ~ seqMethod, adjust = "FDR")$contrasts #Run pairwise comparisons (estimated marginal means). Obtain log odd ratio results and not confidence intervals for individual methods. Specify FDR instead of Tukey post-hoc test (default)
```
...
```{r}
emmeans(McapCpGModModel, pairwise ~ seqMethod, adjust = "FDR")$contrasts #Run pairwise comparisons (estimated marginal means). Obtain log odd ratio results and not confidence intervals for individual methods. Specify FDR instead of Tukey post-hoc test (default)
```
...
```{r}
emmeans(McapCpGLowModel, pairwise ~ seqMethod, adjust = "FDR")$contrasts #Run pairwise comparisons (estimated marginal means). Obtain log odd ratio results and not confidence intervals for individual methods. Specify FDR instead of Tukey post-hoc test (default)
```
