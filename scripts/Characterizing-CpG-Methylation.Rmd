...
```{r}
emmeans(McapCpGHighModel, pairwise ~ seqMethod, adjust = "FDR")$contrasts #Run pairwise comparisons (estimated marginal means). Specify FDR instead of Tukey post-hoc test (default)
```
