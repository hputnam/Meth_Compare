...
summary(McapCpGHighModel.GeneNull) #CDS and introns significantly contribute to proportion of highly methylated CpGs
```
...
summary(McapCpGModerateModel.notGeneNull) #Upstream flanks and intergenic regions contribute significantly to proportion of moderately methylated CpGs
```
...
summary(McapCpGLowModel.GeneNull) #CDS significantly contributes to proportion of lowly methylated CpGs
```
...
summary(McapCpGLowModel.notGeneNull) #Upstream flanks contribute significantly to proportion of lowly methylated CpGs
```
...
summary(PactCpGHighModel.GeneNull) #All parameters significantly contribute to proportion of highly methylated CpGs
```
...
summary(PactCpGHighModel.notGeneNull) #All parameters contribute significantly to proportion of highly methylated CpGs
```
...
summary(PactCpGModerateModel.Gene) #No parameter significantly contributes to proportion of moderately methylated CpGs. MBD-BS has less prop moderately methylated CpGs than RRBS and WGBS.
```
...
summary(PactCpGModerateModel.notGeneNull) #All parameters contribute significantly to proportion of moderately methylated CpGs
```
...
summary(PactCpGLowModel.GeneNull) #CDS and introns significantly contribute to proportion of lowly methylated CpGs
```
...
summary(PactCpGLowModel.notGeneNull) #Flanks contribute significantly to proportion of lowly methylated CpGs
```
