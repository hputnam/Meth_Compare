...
par(mfrow = c(2, 2), oma = c(5, 2, 2, 0), mar = c(3, 3, 3, 5)) #Set up parameters for multipanel plot

#Mcap methylation status

fig.McapCpGPercentsPCoA <- ordiplot(McapCpGPercentsPCoA, choices = c(1,2), type = "none", display = "sites", cex = 0.5, xlab = "", ylab = "", xaxt = "n", yaxt = "n") #Use ordiplot to create base biplot. Do not add any points
...
axis(side =  1, labels = TRUE, col = "grey80", cex.axis = 1.2) #Add x-axis
mtext(side = 1, text = "PCoA 1 (83.1%)", line = 3.5, cex = 1.5) #Add x-axis label

axis(side =  2, labels = TRUE, col = "grey80", cex.axis = 1.2) #Add y-axis
mtext(side = 2, text = "PCoA 2 (16.9%)", line = 3.5, cex = 1.5) #Add y-axis label
...
fig.McapFeatureOverlapsPCoA <- ordiplot(McapFeatureOverlapsPCoA, choices = c(1,2), type = "none", display = "sites", cex = 0.5, xlab = "", ylab = "", xaxt = "n", yaxt = "n") #Use ordiplot to create base biplot. Do not add any points
...
axis(side =  1, labels = TRUE, col = "grey80", cex.axis = 1.2) #Add x-axis
mtext(side = 1, text = "PCoA 1 (92.3%)", line = 3.5, cex = 1.5) #Add x-axis label

axis(side =  2, labels = TRUE, col = "grey80", cex.axis = 1.2) #Add y-axis
mtext(side = 2, text = "PCoA 2 (7.4%)", line = 3.5, cex = 1.5) #Add y-axis label

plot(vec.McapFeatureOverlapsPCoA, p.max = 0.05, col = "black") #Plot loadings that are significant at the 0.05 level

#Pact methylation status

fig.PactCpGPercentsPCoA <- ordiplot(PactCpGPercentsPCoA, choices = c(1,2), type = "none", display = "sites", cex = 0.5, xlab = "", ylab = "", xaxt = "n", yaxt = "n") #Use ordiplot to create base biplot. Do not add any points
...
axis(side =  1, labels = TRUE, col = "grey80", cex.axis = 1.2) #Add x-axis
mtext(side = 1, text = "PCoA 1 (97.9%)", line = 3.5, cex = 1.5) #Add x-axis label

axis(side =  2, labels = TRUE, col = "grey80", cex.axis = 1.2) #Add y-axis
mtext(side = 2, text = "PCoA 2 (2.1%)", line = 3.5, cex = 1.5) #Add y-axis label

plot(vec.PactCpGPercentsPCoA, p.max = 0.05, col = "black") #Plot loadings that are significant at the 0.05 level

#Pact genomic location

fig.PactFeatureOverlapsPCoA <- ordiplot(PactFeatureOverlapsPCoA, choices = c(1,2), type = "none", display = "sites", cex = 0.5, xlab = "", ylab = "", xaxt = "n", yaxt = "n") #Use ordiplot to create base biplot. Do not add any points
...
axis(side =  1, labels = TRUE, col = "grey80", cex.axis = 1.2) #Add x-axis
mtext(side = 1, text = "PCoA 1 (82.5%)", line = 3.5, cex = 1.5) #Add x-axis label

axis(side =  2, labels = TRUE, col = "grey80", cex.axis = 1.2) #Add y-axis
mtext(side = 2, text = "PCoA 2 (15.0%)", line = 3.5, cex = 1.5) #Add y-axis label

plot(vec.PactFeatureOverlapsPCoA, p.max = 0.05, col = "black") #Plot loadings that are significant at the 0.05 level
