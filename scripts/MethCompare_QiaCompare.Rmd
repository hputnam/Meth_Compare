...
##~~~~~~~~~~~~~~~~
####FULL DATASET TRIMGALORE _MCap
##~~~~~~~~~~~~~~
#Deduplicated
```{bash}
wget -r -l1 --no-parent -A "*merged_CpG_evidence.cov" \
https://gannet.fish.washington.edu/seashell/bu-mox/scrubbed/031520-TG-100g/Mcap_tg/dedup --directory-prefix="../data/"
...
```{bash}
wget -r -l1 --no-parent -A "*merged_CpG_evidence.cov" \
https://gannet.fish.washington.edu/seashell/bu-mox/scrubbed/031520-TG-100g/Mcap_tg/nodedup --directory-prefix="../data/"
...
```{r}
library(methylKit)
MC_all_TG.list=list('../data/gannet.fish.washington.edu/seashell/bu-mox/scrubbed/031520-TG-100g/Mcap_tg/dedup/Meth10_R1_001_val_1_bismark_bt2_pe..CpG_report.merged_CpG_evidence.cov',
...
##~~~~~~~~~~~~~~~~
####FULL DATASET TRIMGALORE _Pact, Pact_C1
##~~~~~~~~~~~~~~
##Pact
#Deduplicated
```{bash}
wget -r -l1 --no-parent -A "*merged_CpG_evidence.cov" \
https://gannet.fish.washington.edu/seashell/bu-mox/scrubbed/031520-TG-100g/Pact_tg/dedup --directory-prefix="../data/"

```

#No deduplicated --missing 5 & 6
```{bash}
wget -r -l1 --no-parent -A "*merged_CpG_evidence.cov" \
https://gannet.fish.washington.edu/seashell/bu-mox/scrubbed/031520-TG-100g/Pact_tg/nodedup --directory-prefix="../data/"

```

#No deduplicated --just 5 & 6
```{bash}
wget -r -l1 --no-parent -A "*merged_CpG_evidence.cov" \
...
```{r}
library(methylKit)
Pact_all_TG.list=list('../data/gannet.fish.washington.edu/seashell/bu-mox/scrubbed/031520-TG-100g/Pact_tg/dedup/Meth1_R1_001_val_1_bismark_bt2_pe..CpG_report.merged_CpG_evidence.cov',
