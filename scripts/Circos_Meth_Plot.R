...
#  filter(V1=="scaffold1_cov55" | V1=="scaffold2_cov51" | V1=="scaffold3_cov83" | V1 == "scaffold4_cov57" | V1 == "scaffold6_cov64" | V1 == "scaffold7_cov100")
...
#Pact_union <- Pact %>% 
#  filter(chrom=="scaffold1_cov55" | chrom=="scaffold2_cov51" | chrom=="scaffold3_cov83" | chrom == "scaffold4_cov57" | chrom == "scaffold6_cov64" | chrom == "scaffold7_cov100")
...
circos.genomicTrack(Pact_union.MBDBS, stack=FALSE, ylim=c(0,1),
                    panel.fun = function(region, value, ...) {
                      circos.genomicPoints(region, value, pch = 16, cex = 0.5, col="orange")
                    })
circos.genomicTrack(Pact_union.RRBS, stack=FALSE, ylim=c(0,1),
                    panel.fun = function(region, value, ...) {
                      circos.genomicPoints(region, value, pch = 16, cex = 0.5, col="green")
                    })
